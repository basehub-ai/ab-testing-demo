...
export interface Scalars {
  ...
  type: "file"
    ...
    BSHBSelect_2138716092: 'flashy' | 'lowkey',
    Boolean: boolean,
...
export type BlockDocument = (CalloutComponent | Components | CtaComponent | Features | FeaturesComponent | FeaturesItem | Homepage | Settings | Variants | _AgentStart | calloutComponent_AsList | ctaComponent_AsList | featuresComponent_AsList | featuresItem_AsList) & { __isUnion?: true }
...
export type BlockList = (Features | calloutComponent_AsList | ctaComponent_AsList | featuresComponent_AsList | featuresItem_AsList) & { __isUnion?: true }
...
export interface CalloutComponent {
    ...
    _highlight: (SearchHighlight_55FlIZSKTsQkbmlpbjkzX[] | null)
    _id: Scalars['String']
...
export interface CtaComponent {
    ...
    _dashboardUrl: Scalars['String']
    /** Array of search highlight information with field names and HTML markup */
    _highlight: (SearchHighlight_i3jfPK7t9NsOIwWIAZxjt[] | null)
    _id: Scalars['String']
    _idPath: Scalars['String']
    _slug: Scalars['String']
    _slugPath: Scalars['String']
...
export type CtaComponentOrderByEnum = '_sys_createdAt__ASC' | '_sys_createdAt__DESC' | '_sys_hash__ASC' | '_sys_hash__DESC' | '_sys_id__ASC' | '_sys_id__DESC' | '_sys_lastModifiedAt__ASC' | '_sys_lastModifiedAt__DESC' | '_sys_slug__ASC' | '_sys_slug__DESC' | '_sys_title__ASC' | '_sys_title__DESC' | 'href__ASC' | 'href__DESC' | 'label__ASC' | 'label__DESC'
...
export interface FeaturesComponent {
    ...
    _dashboardUrl: Scalars['String']
    /** Array of search highlight information with field names and HTML markup */
    _highlight: (SearchHighlight_AeeQpjzQUABzmBdK99SMH[] | null)
    _id: Scalars['String']
    _idPath: Scalars['String']
    _slug: Scalars['String']
    _slugPath: Scalars['String']
    ...
    features: Features
    title: (Scalars['String'] | null)
    __typename: 'FeaturesComponent'
}

export type FeaturesComponentOrderByEnum = '_sys_createdAt__ASC' | '_sys_createdAt__DESC' | '_sys_hash__ASC' | '_sys_hash__DESC' | '_sys_id__ASC' | '_sys_id__DESC' | '_sys_lastModifiedAt__ASC' | '_sys_lastModifiedAt__DESC' | '_sys_slug__ASC' | '_sys_slug__DESC' | '_sys_title__ASC' | '_sys_title__DESC' | 'features__ASC' | 'features__DESC' | 'title__ASC' | 'title__DESC'

export interface FeaturesItem {
    _analyticsKey: Scalars['String']
    _dashboardUrl: Scalars['String']
    /** Array of search highlight information with field names and HTML markup */
    _highlight: (SearchHighlight_cd93e21f3662ee64ecb1c[] | null)
    _id: Scalars['String']
    _idPath: Scalars['String']
    _slug: Scalars['String']
    _slugPath: Scalars['String']
...
export type FeaturesItemOrderByEnum = '_sys_createdAt__ASC' | '_sys_createdAt__DESC' | '_sys_hash__ASC' | '_sys_hash__DESC' | '_sys_id__ASC' | '_sys_id__DESC' | '_sys_lastModifiedAt__ASC' | '_sys_lastModifiedAt__DESC' | '_sys_slug__ASC' | '_sys_slug__DESC' | '_sys_title__ASC' | '_sys_title__DESC' | 'body__ASC' | 'body__DESC' | 'icon__ASC' | 'icon__DESC'
...
export interface Homepage {
    ...
    heroTitle: (Scalars['String'] | null)
    primaryCta: CtaComponent
    secondaryCta: CtaComponent
    sections: (UnionCalloutComponentFeaturesComponent[] | null)
    __typename: 'Homepage'
}
...
export interface SearchHighlight_55FlIZSKTsQkbmlpbjkzX {
    /** The field/path that was matched (e.g., "title", "body.content") */
    by: Scalars['String']
    /** HTML snippet with <mark> tags around the matched terms */
    snippet: Scalars['String']
    __typename: 'SearchHighlight_55FlIZSKTsQkbmlpbjkzX'
}

export interface SearchHighlight_AeeQpjzQUABzmBdK99SMH {
    /** The field/path that was matched (e.g., "title", "body.content") */
    by: Scalars['String']
    /** HTML snippet with <mark> tags around the matched terms */
    snippet: Scalars['String']
    __typename: 'SearchHighlight_AeeQpjzQUABzmBdK99SMH'
}

export interface SearchHighlight_cd93e21f3662ee64ecb1c {
    /** The field/path that was matched (e.g., "title", "body.content") */
    by: Scalars['String']
    /** HTML snippet with <mark> tags around the matched terms */
    snippet: Scalars['String']
    __typename: 'SearchHighlight_cd93e21f3662ee64ecb1c'
}

export interface SearchHighlight_i3jfPK7t9NsOIwWIAZxjt {
    /** The field/path that was matched (e.g., "title", "body.content") */
    by: Scalars['String']
    /** HTML snippet with <mark> tags around the matched terms */
    snippet: Scalars['String']
    __typename: 'SearchHighlight_i3jfPK7t9NsOIwWIAZxjt'
}
...
export type UnionCalloutComponentFeaturesComponent = (CalloutComponent | FeaturesComponent) & { __isUnion?: true }
...
export interface _components {
    ...
    cta: ctaComponent_AsList
    features: featuresComponent_AsList
...
export interface ctaComponent_AsList {
    _analyticsKey: Scalars['String']
    _dashboardUrl: Scalars['String']
    _id: Scalars['String']
    _idPath: Scalars['String']
    ...
    _title: Scalars['String']
    /** Returns the first item in the list, or null if the list is empty. Useful when you expect only one result. */
    item: (CtaComponent | null)
    /** Returns the list of items after filtering and paginating according to the arguments sent by the client. */
    items: CtaComponent[]
    __typename: 'ctaComponent_AsList'
}

export interface featuresComponent_AsList {
    _analyticsKey: Scalars['String']
    _dashboardUrl: Scalars['String']
    _id: Scalars['String']
    _idPath: Scalars['String']
    ...
    _title: Scalars['String']
    /** Returns the first item in the list, or null if the list is empty. Useful when you expect only one result. */
    item: (FeaturesComponent | null)
    /** Returns the list of items after filtering and paginating according to the arguments sent by the client. */
    items: FeaturesComponent[]
    __typename: 'featuresComponent_AsList'
}
...
export interface BlockDocumentGenqlSelection{
    ...
    on_CtaComponent?: CtaComponentGenqlSelection
    on_Features?: FeaturesGenqlSelection
    on_FeaturesComponent?: FeaturesComponentGenqlSelection
    on_FeaturesItem?: FeaturesItemGenqlSelection
    on_Homepage?: HomepageGenqlSelection
    on_Settings?: SettingsGenqlSelection
    on_Variants?: VariantsGenqlSelection
    on__AgentStart?: _AgentStartGenqlSelection
    on_calloutComponent_AsList?: calloutComponent_AsListGenqlSelection
    on_ctaComponent_AsList?: ctaComponent_AsListGenqlSelection
    on_featuresComponent_AsList?: featuresComponent_AsListGenqlSelection
...
export interface CalloutComponentGenqlSelection{
    ...
    _dashboardUrl?: boolean | number
    /** Array of search highlight information with field names and HTML markup */
    _highlight?: SearchHighlight_55FlIZSKTsQkbmlpbjkzXGenqlSelection
    _id?: boolean | number
    _idPath?: boolean | number
    _slug?: boolean | number
    _slugPath?: boolean | number
...
export interface CtaComponentGenqlSelection{
    _analyticsKey?: { __args: {
    /**
     * The scope of the analytics key. Use `send` for just ingesting data. Use `query` if you need to show an analytics data in your website.
     * 
    ...
    _dashboardUrl?: boolean | number
    /** Array of search highlight information with field names and HTML markup */
    _highlight?: SearchHighlight_i3jfPK7t9NsOIwWIAZxjtGenqlSelection
    _id?: boolean | number
    _idPath?: boolean | number
    _slug?: boolean | number
    _slugPath?: boolean | number
    ...
    __typename?: boolean | number
    __fragmentOn?: "CtaComponent"
}

export interface CtaComponentFilterInput {AND?: (CtaComponentFilterInput | null),OR?: (CtaComponentFilterInput | null),_id?: (StringFilter | null),_slug?: (StringFilter | null),_sys_apiNamePath?: (StringFilter | null),_sys_createdAt?: (DateFilter | null),_sys_hash?: (StringFilter | null),_sys_id?: (StringFilter | null),_sys_idPath?: (StringFilter | null),_sys_lastModifiedAt?: (DateFilter | null),_sys_slug?: (StringFilter | null),_sys_slugPath?: (StringFilter | null),_sys_title?: (StringFilter | null),_title?: (StringFilter | null),href?: (StringFilter | null),label?: (StringFilter | null)}

export interface CtaComponentSearchInput {
/** Searchable fields for query */
by?: (Scalars['String'][] | null),
/** Search query */
q?: (Scalars['String'] | null)}
...
export interface FeaturesComponentGenqlSelection{
    _analyticsKey?: { __args: {
    /**
     * The scope of the analytics key. Use `send` for just ingesting data. Use `query` if you need to show an analytics data in your website.
     * 
    ...
    _dashboardUrl?: boolean | number
    /** Array of search highlight information with field names and HTML markup */
    _highlight?: SearchHighlight_AeeQpjzQUABzmBdK99SMHGenqlSelection
    _id?: boolean | number
    _idPath?: boolean | number
    _slug?: boolean | number
    _slugPath?: boolean | number
    ...
    search?: (FeaturesItemSearchInput | null), 
    /** Skip the first n items. */
    skip?: (Scalars['Int'] | null)} })
    title?: boolean | number
    __typename?: boolean | number
    __fragmentOn?: "FeaturesComponent"
}

export interface FeaturesComponentFilterInput {AND?: (FeaturesComponentFilterInput | null),OR?: (FeaturesComponentFilterInput | null),_id?: (StringFilter | null),_slug?: (StringFilter | null),_sys_apiNamePath?: (StringFilter | null),_sys_createdAt?: (DateFilter | null),_sys_hash?: (StringFilter | null),_sys_id?: (StringFilter | null),_sys_idPath?: (StringFilter | null),_sys_lastModifiedAt?: (DateFilter | null),_sys_slug?: (StringFilter | null),_sys_slugPath?: (StringFilter | null),_sys_title?: (StringFilter | null),_title?: (StringFilter | null),features?: (ListFilter | null),title?: (StringFilter | null)}

export interface FeaturesComponentSearchInput {
/** Searchable fields for query */
by?: (Scalars['String'][] | null),
/** Search query */
q?: (Scalars['String'] | null)}
...
export interface FeaturesItemGenqlSelection{
    ...
    _dashboardUrl?: boolean | number
    /** Array of search highlight information with field names and HTML markup */
    _highlight?: SearchHighlight_cd93e21f3662ee64ecb1cGenqlSelection
    _id?: boolean | number
    _idPath?: boolean | number
    _slug?: boolean | number
    _slugPath?: boolean | number
...
export interface FeaturesItemSearchInput {
/** Searchable fields for query */
by?: (Scalars['String'][] | null),
/** Search query */
q?: (Scalars['String'] | null)}
...
export interface HomepageGenqlSelection{
    ...
    heroTitle?: boolean | number
    primaryCta?: (CtaComponentGenqlSelection & { __args?: {variants?: (Variants__VariantsInput | null)} })
    secondaryCta?: (CtaComponentGenqlSelection & { __args?: {variants?: (Variants__VariantsInput | null)} })
    sections?: (UnionCalloutComponentFeaturesComponentGenqlSelection & { __args?: {variants?: (Variants__VariantsInput | null)} })
    __typename?: boolean | number
...
export interface QueryGenqlSelection{
    ...
    homepage?: (HomepageGenqlSelection & { __args?: {variants?: (Variants__VariantsInput | null)} })
...
export interface SearchHighlight_55FlIZSKTsQkbmlpbjkzXGenqlSelection{
    /** The field/path that was matched (e.g., "title", "body.content") */
    by?: boolean | number
    /** HTML snippet with <mark> tags around the matched terms */
    snippet?: boolean | number
    __typename?: boolean | number
    __fragmentOn?: "SearchHighlight_55FlIZSKTsQkbmlpbjkzX"
}

export interface SearchHighlight_AeeQpjzQUABzmBdK99SMHGenqlSelection{
    /** The field/path that was matched (e.g., "title", "body.content") */
    by?: boolean | number
    /** HTML snippet with <mark> tags around the matched terms */
    snippet?: boolean | number
    __typename?: boolean | number
    __fragmentOn?: "SearchHighlight_AeeQpjzQUABzmBdK99SMH"
}

export interface SearchHighlight_cd93e21f3662ee64ecb1cGenqlSelection{
    /** The field/path that was matched (e.g., "title", "body.content") */
    by?: boolean | number
    /** HTML snippet with <mark> tags around the matched terms */
    snippet?: boolean | number
    __typename?: boolean | number
    __fragmentOn?: "SearchHighlight_cd93e21f3662ee64ecb1c"
}

export interface SearchHighlight_i3jfPK7t9NsOIwWIAZxjtGenqlSelection{
    /** The field/path that was matched (e.g., "title", "body.content") */
    by?: boolean | number
    /** HTML snippet with <mark> tags around the matched terms */
    snippet?: boolean | number
    __typename?: boolean | number
    __fragmentOn?: "SearchHighlight_i3jfPK7t9NsOIwWIAZxjt"
}
...
export interface SettingsGenqlSelection{
    ...
    _sys?: BlockDocumentSysGenqlSelection
    _title?: boolean | number
    variants?: VariantsGenqlSelection
    __typename?: boolean | number
...
export interface UnionCalloutComponentFeaturesComponentGenqlSelection{
    on_CalloutComponent?:CalloutComponentGenqlSelection,
    on_FeaturesComponent?:FeaturesComponentGenqlSelection,
    on_BlockDocument?: BlockDocumentGenqlSelection,
    __typename?: boolean | number,
    __fragmentOn?: "UnionCalloutComponentFeaturesComponent"
}
...
export interface VariantsGenqlSelection{
    _analyticsKey?: { __args: {
    /**
     * The scope of the analytics key. Use `send` for just ingesting data. Use `query` if you need to show an analytics data in your website.
     * 
    ...
    __typename?: boolean | number
    __fragmentOn?: "Variants"
}

export interface Variants__VariantsInput {variants?: (VariantsEnum | null)}
...
export interface _componentsGenqlSelection{
    ...
    /** Skip the first n items. */
    skip?: (Scalars['Int'] | null)} })
    cta?: (ctaComponent_AsListGenqlSelection & { __args?: {
    /** Filter by a field. */
    filter?: (CtaComponentFilterInput | null), 
    /** Limit the number of items returned. Defaults to 500. */
    first?: (Scalars['Int'] | null), 
    /** Order by a field. */
    orderBy?: (CtaComponentOrderByEnum | null), 
    /** Search configuration */
    search?: (CtaComponentSearchInput | null), 
    /** Skip the first n items. */
    skip?: (Scalars['Int'] | null), variants?: (Variants__VariantsInput | null)} })
    features?: (featuresComponent_AsListGenqlSelection & { __args?: {
    /** Filter by a field. */
    filter?: (FeaturesComponentFilterInput | null), 
    /** Limit the number of items returned. Defaults to 500. */
    first?: (Scalars['Int'] | null), 
    /** Order by a field. */
    orderBy?: (FeaturesComponentOrderByEnum | null), 
    /** Search configuration */
    search?: (FeaturesComponentSearchInput | null), 
    /** Skip the first n items. */
    skip?: (Scalars['Int'] | null)} })
...
export interface ctaComponent_AsListGenqlSelection{
    _analyticsKey?: { __args: {
    /**
     * The scope of the analytics key. Use `send` for just ingesting data. Use `query` if you need to show an analytics data in your website.
     * 
    ...
    _title?: boolean | number
    /** Returns the first item in the list, or null if the list is empty. Useful when you expect only one result. */
    item?: CtaComponentGenqlSelection
    /** Returns the list of items after filtering and paginating according to the arguments sent by the client. */
    items?: CtaComponentGenqlSelection
    __typename?: boolean | number
    __fragmentOn?: "ctaComponent_AsList"
}

export interface featuresComponent_AsListGenqlSelection{
    _analyticsKey?: { __args: {
    /**
     * The scope of the analytics key. Use `send` for just ingesting data. Use `query` if you need to show an analytics data in your website.
     * 
    ...
    _title?: boolean | number
    /** Returns the first item in the list, or null if the list is empty. Useful when you expect only one result. */
    item?: FeaturesComponentGenqlSelection
    /** Returns the list of items after filtering and paginating according to the arguments sent by the client. */
    items?: FeaturesComponentGenqlSelection
    __typename?: boolean | number
    __fragmentOn?: "featuresComponent_AsList"
}
...
export interface featuresItem_AsListGenqlSelection{
    ...
    items?: FeaturesItemGenqlSelection
    __typename?: boolean | number
    __fragmentOn?: "featuresItem_AsList"
}
...
export interface FragmentsMap {
  ...
  CtaComponent: {
    root: CtaComponent,
    selection: CtaComponentGenqlSelection,
}
  Features: {
    root: Features,
  ...
  FeaturesComponent: {
    root: FeaturesComponent,
    selection: FeaturesComponentGenqlSelection,
}
  FeaturesItem: {
    root: FeaturesItem,
  ...
  SearchHighlight_55FlIZSKTsQkbmlpbjkzX: {
    root: SearchHighlight_55FlIZSKTsQkbmlpbjkzX,
    selection: SearchHighlight_55FlIZSKTsQkbmlpbjkzXGenqlSelection,
}
  SearchHighlight_AeeQpjzQUABzmBdK99SMH: {
    root: SearchHighlight_AeeQpjzQUABzmBdK99SMH,
    selection: SearchHighlight_AeeQpjzQUABzmBdK99SMHGenqlSelection,
}
  SearchHighlight_cd93e21f3662ee64ecb1c: {
    root: SearchHighlight_cd93e21f3662ee64ecb1c,
    selection: SearchHighlight_cd93e21f3662ee64ecb1cGenqlSelection,
}
  SearchHighlight_i3jfPK7t9NsOIwWIAZxjt: {
    root: SearchHighlight_i3jfPK7t9NsOIwWIAZxjt,
    selection: SearchHighlight_i3jfPK7t9NsOIwWIAZxjtGenqlSelection,
}
  Settings: {
    root: Settings,
  ...
  Variants: {
    root: Variants,
    selection: VariantsGenqlSelection,
}
  _AgentStart: {
    root: _AgentStart,
  ...
  ctaComponent_AsList: {
    root: ctaComponent_AsList,
    selection: ctaComponent_AsListGenqlSelection,
}
  featuresComponent_AsList: {
    root: featuresComponent_AsList,
    selection: featuresComponent_AsListGenqlSelection,
}
  featuresItem_AsList: {
